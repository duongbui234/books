...
> Cơ sở dữ liệu xử lý phân tích trực tuyến (OLAP) Loại này xử lý các phép tổng hợp phức tạp. Cơ sở dữ liệu OLAP thường được dùng cho phân tích và kho dữ liệu (data warehousing), và có khả năng xử lý các truy vấn ad hoc phức tạp, chạy dài.
