...
> Vì phần lớn độ phức tạp trong B-Tree đến từ tính khả biến (mutability), chúng ta bàn chi tiết về bố cục trang, việc tách trang, di dời trang và các khái niệm khác áp dụng được cho những cấu trúc dữ liệu khả biến. Về sau, khi nói tới LSM Tree (xem mục "LSM Trees" trang 130), chúng ta tập trung vào việc sắp xếp và bảo trì, vì đó là nơi sinh ra phần lớn độ phức tạp của LSM.
