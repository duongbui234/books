...
> Việc bầu chọn được kích hoạt khi hệ thống khởi tạo và leader được bầu lần đầu tiên, hoặc khi leader trước đó sập hay không còn liên lạc được. Việc bầu chọn phải mang tính tất định: đúng một leader phải xuất hiện từ tiến trình này. Quyết định đó cần có hiệu lực đối với tất cả các bên tham gia.
...
2. The process waits, allowing higher-ranked processes to respond. If no higher-ranked process responds, it proceeds with step 3. Otherwise, the process notifies the highest-ranked process it has heard from, and allows it to proceed with step
3. 
...
> 1. Tiến trình gửi các thông điệp bầu chọn tới những tiến trình có định danh cao hơn.
> 2. Tiến trình chờ, để các tiến trình thứ hạng cao hơn có cơ hội phản hồi. Nếu không tiến trình thứ hạng cao hơn nào phản hồi, nó chuyển sang bước 3. Ngược lại, tiến trình thông báo cho tiến trình có thứ hạng cao nhất mà nó nhận được phản hồi, và để tiến trình đó tiếp tục với bước
> 3. 
> 3. Tiến trình giả định rằng không còn tiến trình đang hoạt động nào có thứ hạng cao hơn, và thông báo cho tất cả các tiến trình thứ hạng thấp hơn về leader mới.
