...
> Ngày nay, lĩnh vực này lại đang thay đổi: sau thời của các kho khóa-giá trị (key-value store), NoSQL và nhất quán cuối cùng (eventual consistency), chúng ta bắt đầu thấy xuất hiện những cơ sở dữ liệu có khả năng mở rộng và hiệu năng tốt hơn, đủ sức thực thi các truy vấn phức tạp với những bảo đảm nhất quán mạnh hơn.
...
> Để thu thập tài liệu cho cuốn sách này, tôi đã nghiên cứu hơn 15 cuốn sách, hơn 300 bài báo, vô số bài viết blog, mã nguồn và tài liệu của một số cơ sở dữ liệu mã nguồn mở. Nguyên tắc để quyết định có đưa một khái niệm cụ thể vào sách hay không là câu hỏi: "Những người trong ngành cơ sở dữ liệu và trong giới nghiên cứu có bàn về khái niệm này không?" Nếu câu trả lời là "có", tôi thêm khái niệm đó vào danh sách dài những thứ cần thảo luận.
...
> Vì một trong những việc khó nhất trong hệ phân tán là đạt được tính nhất quán dữ liệu, chúng ta bàn về các khái niệm nhân bản (replication), tiếp đó là các mô hình nhất quán, khả năng phân kỳ giữa các bản sao, và nhất quán cuối cùng. Do các hệ nhất quán cuối cùng đôi khi dựa vào anti-entropy để hội tụ và dựa vào gossip để lan truyền dữ liệu, chúng ta bàn về một số cách tiếp cận anti-entropy và gossip. Cuối cùng, chúng ta bàn về nhất quán logic trong ngữ cảnh giao dịch cơ sở dữ liệu, và khép lại bằng các thuật toán đồng thuận (consensus).
...
O’Reilly Media, Inc. 1005 Gravenstein Highway North Sebastopol, CA 95472 800-998-9938 (in the United States or Canada) 707-829-0515 (international or local) 707-829-0104 (fax) We have a web page for this book, where we list errata, examples, and any additional information. You can access this page at http://bit.ly/database-internals .

> O'Reilly Media, Inc. 1005 Gravenstein Highway North Sebastopol, CA 95472 800-998-9938 (tại Hoa Kỳ hoặc Canada) 707-829-0515 (quốc tế hoặc nội hạt) 707-829-0104 (fax) Chúng tôi có một trang web dành cho cuốn sách này, nơi liệt kê các đính chính (errata), ví dụ và mọi thông tin bổ sung. Bạn có thể truy cập trang này tại http://bit.ly/database-internals .
